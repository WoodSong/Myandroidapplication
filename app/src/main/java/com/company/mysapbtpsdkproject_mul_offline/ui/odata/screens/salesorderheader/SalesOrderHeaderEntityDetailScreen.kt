        ...
        Column {
            ...
            if (entity != null) {
                ...
                Column(
                    ...
                    TextButton(onClick = {
                        onNavigateProperty(entity, SalesOrderHeader.customer, EntityOperationType.DETAIL)
                    }) {
                        Text("Customer", color = MaterialTheme.fioriHorizonAttributes.SapFioriColorT6)
                    }

                    TextButton(onClick = {
                        onNavigateProperty(entity, SalesOrderHeader.items, EntityOperationType.DETAIL)
                    }) {
