...
import com.company.mysapbtpsdkproject_mul_offline.ui.odata.data.ComplexTypePageSource
...
open class ComplexTypeViewModel(
    ...
    override val internalPagingSourceFactory: () -> PagingSource<Int, ComplexValue> = {
