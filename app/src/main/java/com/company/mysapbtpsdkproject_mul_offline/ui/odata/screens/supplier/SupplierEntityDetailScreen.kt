...
import com.company.mysapbtpsdkproject_mul_offline.ui.odata.*
import com.company.mysapbtpsdkproject_mul_offline.ui.odata.screens.*
import com.company.mysapbtpsdkproject_mul_offline.ui.odata.viewmodel.*
        ...
        Column {
            ...
            if (entity != null) {
                ...
                Column(
                    ...
                    TextButton(onClick = {
                        onNavigateProperty(entity, Supplier.address, EntityOperationType.DETAIL)
                    }) {
                        Text("Address", color = MaterialTheme.fioriHorizonAttributes.SapFioriColorT6)
                    }

                    TextButton(onClick = {
                        onNavigateProperty(entity, Supplier.products, EntityOperationType.DETAIL)
                    }) {
                        Text("Products", color = MaterialTheme.fioriHorizonAttributes.SapFioriColorT6)
                    }

                    TextButton(onClick = {
                        onNavigateProperty(entity, Supplier.purchaseOrders, EntityOperationType.DETAIL)
                    }) {
